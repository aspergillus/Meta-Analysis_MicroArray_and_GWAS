    ...
    k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
        ...
        a = a.downloadURL = function (a, l) {
            var n = d.navigator,
                c = p.createElement("a");
            if ("string" ===
                typeof a || a instanceof String || !n.msSaveOrOpenBlob) {
                a = "" + a;
                n = /Edge\/\d+/.test(n.userAgent);
                if (f && "string" === typeof a && 0 === a.indexOf("data:application/pdf") || n || 2E6 < a.length)
    ...
    k(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]], function (a, f, d, p, l, r, n) {
        function k(a, m) {
            ...
            try {
                ...
                if (!c) return d.createObjectURL(new g.Blob(["\ufeff" +
                    a
                ], {
                    type: m
                }))
        ...
        f.prototype.getDataRows = function (b) {
            ...
            this.series.forEach(function (a) {
                ...
                if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                    ...
                    for (l = 0; l < f;) z = w(a, q[l], q.length), p.push(z.columnTitle || z), b && n.push(z.topLevelColumnTitle || z), l++;
                    var A = {
                        chart: a.chart,
                    ...
                    a.options.data.forEach(function (b, d) {
                        ...
                        t[b].x = w.x;
                        t[b].name = h;
                        for (t[b].xValues[k] = w.x; l < f;) d = q[l], h = w[d], t[b][x + l] = v(B.categoryMap[d][h], B.dateTimeValueAxisMap[d] ? y.dateFormat(c.dateFormat, h) : null, h), l++
                    });
                    x += l
                }
            });
        ...
        f.prototype.getCSV = function (a) {
            ...
            d.forEach(function (a, c) {
                for (var m, y = a.length; y--;) m = a[y], "string" === typeof m && (m = '"' + m + '"'), "number" === typeof m && "." !== f && (m = m.toString().replace(".", f)), a[y] = m;
                b += a.join(l);
                c < d.length - 1 && (b += g)
            });
            return b
        ...
        f.prototype.toggleDataTable = function (a) {
            ...
            b = this.options.lang;
            u && u.menuItemDefinitions && b && b.viewData && b.hideData && c && a && (a = a[c.indexOf("viewData")]) && d.setElementHTML(a, this.isDataTableVisible ?
