...
<form action="gwas.php" method="post">
<p>&nbsp;</p>
<p>
    <div style="display: inline-flex;" colspan="3">
        <div>
            <input type="radio" name="dataset" class="sel_dat" value="disease"
                <?php
                    if($dataset == "disease"){
                        ?>checked = "checked"<?php 
                    }
                ?>
            >
            <strong>Disease/Trait</strong>
        </div>
        &nbsp;&nbsp;
        <div>
            <input type="radio" name="dataset" class="sel_dat" value="efo"
                <?php
                    if($dataset == "efo"){
                        ?>checked = "checked"<?php 
                    }
...
<form action="result.php" method="post" name="myForm" id="gwasQuery">
        ...
        <tr>
            <td colspan="3">
                <div align="center">
                    ...
                    <div align="center">
                        <p>Merge selected disease/trait <input type="text" name="merge_select" value=""></p>
                    </div>

                    <div align="center">
                        &nbsp;<input class="allBtn" type="submit" name="button" id="btn_result" value="Submit" />&nbsp;&nbsp;
                    </div>
                </div>
            </td>
        </tr>
